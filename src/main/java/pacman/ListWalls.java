...
public class ListWalls {
    ...
    public void addWall() {
        ...
        for (int i = 60; i < 840; i += 30) {
            if (i != 180 && i != 690) {
                walls.add(new Wall(i, 60, true)); //row2
            }
            if (i != 90 && i != 270) {
                walls.add(new Wall(i, 120, true)); //row3
            }
        }
        for (int i = 300; i < 840; i += 30) {
            if (i != 390 && i != 510 && i != 570) {
                walls.add(new Wall(i, 180, true)); // row4
            }
        }
        for (int i = 450; i < 840; i += 30) {
            if (i != 510 && i != 570 && i != 630 && i != 780) {
                walls.add(new Wall(i, 240, true)); // row5
            }
        }
        for (int i = 630; i < 810; i += 30) {
            if (i != 630 && i != 780) {
                walls.add(new Wall(i, 300, true)); // row6
            }
            if (i != 780) {
                walls.add(new Wall(i, 360, true)); // row7
            }
        ...
        for (int i = 60; i < 840; i += 30) {
            if (i != 180 && i != 360 && i != 420 && i != 660 && i != 720 && i != 780) {
        ...
        for (int i = 120; i < 750; i += 30) {
            if (i == 360 || i == 630) {
                ...
                walls.add(new Wall(60, i, true)); // column 2
            }
            walls.add(new Wall(120, i, true)); // column 3
            if (i != 150 && i != 270 && i != 420 && i != 480) {
                walls.add(new Wall(180, i, true)); // column4
            }
            walls.add(new Wall(240, i, true)); // column 5
            if (i != 150 && i != 240 && i != 510) {
                walls.add(new Wall(300, i, true)); //column 6
            }
            if (i != 150 && i != 690) {
                walls.add(new Wall(360, i, true)); // column7
            }
            if (i != 150 && i != 270 && i != 570 && i != 720 && i != 750) {
                walls.add(new Wall(420, i, true)); //column8
            }
            if (i != 150 && i != 210 && i != 450) {
                walls.add(new Wall(480, i, true)); // column 9
            }
            walls.add(new Wall(540, i, true)); //column10
            if (i != 150 && i != 330 && i != 390 && i != 750) {
                walls.add(new Wall(600, i, true)); // column11
            }
            if (i != 150 && i != 450 && i != 570 && i != 690 && i != 750) {
                walls.add(new Wall(810, i, true)); // column12
            }
        }
    }
